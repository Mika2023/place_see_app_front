...
class _RecommendationsScreenState extends State<RecommendationsScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<RecommendationsViewModel>().loadPlaces();
  ...
  Future<void> openFilters(BuildContext context, PlacesFiltersState state, RecommendationsViewModel vm) async {
